...
|---|---|---|
| DEPOSIT (입금) | 101 현금 | 201 고객예금 |
| WITHDRAWAL (출금) | 201 고객예금 | 101 현금 |
| TRANSFER_IN (타행 이체 입금) | 501 이체대기 | 201 고객예금 |
| TRANSFER_OUT (타행 이체 출금) | 201 고객예금 | 501 이체대기 |
| FEE (수수료) | 201 고객예금 | 401 수수료수익 |
